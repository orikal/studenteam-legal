...
- Circumvent moderation, suspensions, or technical limits.
...
We may **remove, edit, blur, or restrict** content, or **suspend or terminate** accounts, if we reasonably believe there is a violation of these Terms, legal risk, or harm to users or the service. We may use automated and manual tools, user reports, and server-side checks.

### 6.3 Reporting

The App provides mechanisms to **report** concerning content or behavior. We will review reports in a reasonable timeframe but do not guarantee specific outcomes or response times for every report.
